...
namespace Chaos.NaCl.Internal
{
    public static class Sha512Internal
    {
        ...
        public static void Sha512Init(out Array8<UInt64> state)
        {
        ...
        public static void Core(out Array8<UInt64> outputState, ref Array8<UInt64> inputState, ref Array16<UInt64> input)
        {
            unchecked
            {
